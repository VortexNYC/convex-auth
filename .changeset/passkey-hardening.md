...
- **Security:** when `userVerification` is relaxed and the account has TOTP 2FA enabled, passkey sign-in returns the standard `twoFactorRedirect` challenge instead of minting a session — UV-verified ceremonies still satisfy 2FA on their own.
