...
/**
 * `expiresAt` is returned so the token-exchange validator can enforce the
 * expiry the code was issued with (the package's
 * `McpOAuthAuthorizationCodeRecord` requires it).
 */
